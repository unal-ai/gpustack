...
| **Very Long Prompt** | Total TPS: 4337.21<br>Mean TPOT(ms): 224.58 | Total TPS: 4605.91 <span style="background-color:lightgreen;">(+6.2%)</span><br>Mean TPOT(ms): 201.61 |
...
| Parallelism                 | -                              |
| Attention Backend           | -                                   |
| Max Number of Batched Tokens             | <span style="background-color:lightgreen;">+1.2%</span>                                   |

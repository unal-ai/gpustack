# Iluvatar Installation (Experimental)
...
!!! note
    ...
    2. Default container images, such as vLLM, are provided by the [GPUStack runner](https://github.com/gpustack/runner?tab=readme-ov-file#iluvatar-corex).

## Prerequisites

### Iluvatar GPU Driver

Ensure your system has an [Iluvatar GPU Driver](https://support.iluvatar.com/#/login). Verify installation with:
...
It is recommended to use [Docker](https://docs.docker.com/engine/install/) with the [Iluvatar Container Toolkit](https://github.com/Deep-Spark/ix-container-toolkit):
...
- To restrict GPU access, remove `--privileged` flag and set the `IX_VISIBLE_DEVICES` environment variable.
  See [Iluvatar Container Toolkit - GPU Enumeration](https://github.com/Deep-Spark/ix-container-toolkit).
